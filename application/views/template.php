  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('buku/dashboard')?>" class="logo"><b>Fabulous</b></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <a href="index.html#">
                                    <div class="task-info">
                                        <div class="desc">Fabulous Admin Panel</div>
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li>
                    <a class="logout" href="<?=base_url('index.php/admin/logout')?>" onclick="return confirm('Logout Akun ?')">
                    Logout
                    </a>
                    </li>
            	</ul>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="<?= base_url('')?>"><img src="<?=base_url()?>assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
              	  <h5 class="centered"><?=$this->session->userdata('fullname')?></h5>
              	  	
                  <li class="mt">
                      <a class="active" href="<?=base_url('wisata/dashboard')?>">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Daftar Destinasi Wisata</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="<?=base_url('Wisata')?>">Daftar Wisata</a></li>
